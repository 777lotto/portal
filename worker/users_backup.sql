...
, address TEXT, company_name TEXT, email_notifications_enabled INTEGER NOT NULL DEFAULT 1, sms_notifications_enabled INTEGER NOT NULL DEFAULT 1, preferred_contact_method TEXT CHECK(preferred_contact_method IN ('email', 'sms')) DEFAULT 'email', calendar_reminders_enabled INTEGER NOT NULL DEFAULT 1, calendar_reminder_minutes INTEGER NOT NULL DEFAULT 60);
