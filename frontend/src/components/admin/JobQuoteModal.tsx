      ...
      <div className="modal-dialog">
        <div className="modal-content">
          <div className="modal-header">
            <h5 className="modal-title">Add New {type === 'job' ? 'Job/Invoice' : 'Quote'}</h5>
          ...
          <div className="modal-body">
            ...
            <div className="mb-3">
              ...
              <select id="user" className="form-select" value={selectedUserId} onChange={(e) => setSelectedUserId(e.target.value)}>
            ...
            {lineItems.map((item, index) => (
              <div key={index} className="row g-2 mb-2">
                ...
                <div className="col-3">
                  <input type="number" className="form-control" placeholder="Price" value={(item.price_cents || 0) / 100} onChange={(e) => handleLineItemChange(index, 'price_cents', e.target.value)} />
                </div>
                <div className="col-2">
            ...
            <button className="btn btn-secondary" onClick={addLineItem}>Add Item</button>
            <hr />
            {type === 'job' && (
              <div className="mb-3">
            ...
            {type === 'quote' && (
             ...
             <div className="mb-3">
                ...
                <select id="contactMethod" className="form-select" value={contactMethod} onChange={(e) => setContactMethod(e.target.value as any)}>
